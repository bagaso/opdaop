...
class TicketListCloseController extends Controller
{
    /**
    ...
    {
        return view('theme.default.support_tickets.ticket_list_close');
    }

    public function ticket_list()
    {
        $query = Ticket::CloseTickets()->selectRaw('tickets.id, tickets.subject, tickets.is_open, tickets.is_lock');
