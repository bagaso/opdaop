...
class TicketListLockController extends Controller
{
    /**
    ...
    {
        return view('theme.default.support_tickets.ticket_list_lock');
    }

    public function ticket_list()
    {
        $query = Ticket::LockTickets()->selectRaw('tickets.id, tickets.subject, tickets.is_open, tickets.is_lock');
