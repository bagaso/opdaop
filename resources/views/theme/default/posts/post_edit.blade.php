                    ...
                    <div class="col-md-9">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" method="post" action="{{ route('news_and_updates.edit.do_edit', [$post->id, str_slug($post->title, '-')]) }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="pinned"{{ $post->is_pinned ? ' checked' : '' }}> Pinned Post
                                            </label>
                                        </div>

                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="public"{{ $post->is_public ? ' checked' : '' }}> Public Post
                                            </label>
                                        </div>
