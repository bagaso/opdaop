                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('pages.add.do_add') }}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('html_content') ? ' has-error' : '' }}">
                                    ...
                                    <textarea id="html_content" class="textarea" placeholder="Place some text here" name="html_content"
                                              style="width: 100%; height: 350px; resize: none; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
