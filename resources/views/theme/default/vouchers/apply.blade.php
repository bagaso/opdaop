    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Apply Voucher</li>
            </ol>
        </section>
                ...
                <div class="col-md-9">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            @cannot('APPLY_VOUCHER_TO_ACCOUNT')
                            <div class="alert alert-warning alert-dismissible">
                                <h4><i class="icon fa fa-warning"></i> Alert!</h4>
                                No Permission to Apply Voucher.
                            </div>
                            @endcannot
                            @can('APPLY_VOUCHER_TO_ACCOUNT')
                            @if (session('success'))
                            ...
                            @if ($errors->count())
                                <div class="alert alert-danger alert-dismissible">
                                    ...
                                    Apply Voucher Failed.
                                </div>
                            @endif

                            <form action="{{ route('vouchers.apply.do_apply') }}" method="post" class="form-horizontal">
                                {{ csrf_field() }}
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Applied Voucher List</h3>
                        </div>
